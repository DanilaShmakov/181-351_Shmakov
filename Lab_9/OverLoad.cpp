...
/*
Перегрузка - объявление нескольких функций ( а также методов, классов )
...
public:
	...
	friend matrix operator- (const matrix & matr1, matrix & matr2);
	friend matrix operator* (const matrix & matr1, matrix & matr2);
	friend ostream & operator << (ostream & os, matrix & matr2);
	bool input();
	bool print();
...
ostream & operator<<(ostream & os, matrix & matr2)
{
